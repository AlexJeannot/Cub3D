...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/07 12:33:06 by ajeannot          #+#    #+#             */
/*   Updated: 2020/02/08 18:46:02 by ajeannot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		is_texture(char *str)
{
	...
	if (str[0] == 'N' && str[1] == 'O')
		...
		return (KO);
	if (index == 0 && g_config->texture_no == 1)
		exit_game("Error\nNorth texture already defined\n");
	else if (index == 1 && g_config->texture_so == 1)
		exit_game("Error\nSouth texture already defined\n");
	else if (index == 2 && g_config->texture_we == 1)
		exit_game("Error\nWest texture already defined\n");
	else if (index == 3 && g_config->texture_ea == 1)
